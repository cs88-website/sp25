...
def play(strategy0, strategy1, n=0, announce=True):
...
def best(n, other_strategy):
    ...
    0
    """
    future_strategy = lambda future_n: best(future_n, other_strategy)
    for choice in range(1, 4):
        if play(other_strategy, future_strategy, n + choice, False) == 1:
            return choice
    return 1 # Give up :(
